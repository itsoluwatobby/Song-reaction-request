...
export const Top = () => {
  return (
    <header className='sticky top-0 w-full p-2 flex items-center justify-between bg-blue-200 shadow-2xl z-50 bg-opacity-70'>
      ...
      <button className='flex capitalize items-center gap-2 p-2 bg-red-500 border-none text-white text-lg shadow-2xl cursor-pointer hover:bg-red-600 active:bg-red-500 transition-all rounded-full minscreen:uppercase pl-4 pr-4'>
